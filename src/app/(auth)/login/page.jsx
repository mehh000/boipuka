            ...
            <div className=" bg-white gap-5  lg:shadow-md  rounded-md  p-3 flex flex-col">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="text" placeholder='Enter Your email' className=" h-[50px] p-1 w-[400px] border-2 border-gray-300 rounded-md" />
                    </div>
                    <div className="flex flex-col">
                    ...
                    <Link href={'/'} className='w-full rounded-md bg-violet-700 text-center font-medium text-base text-white py-2.5' >
                        Login
                    </Link>
                </div>
                <Link href={'/signup'} >Dont have a account? <span className=" underline text-blue-600">Register free</span></Link>
            </div>
        </div>
    )
}
